...
The idea is that this is a utility belt for basic cybersecurity tasks: scrambling messages so they can't be read, generating strong passwords, and scanning files to find hidden contact info.
